// Format.Case.swift
// Case transformation formatter for strings.

public import Formatter_Primitives

extension Format {
    /// Formatter for case transformation of strings.
    ///
    /// Conforms to `Formatter.Protocol<String, String, Never>`, letting it participate
    /// in the generic `.formatted(_:)` API alongside other formatters.
    ///
    /// ## Example
    ///
    /// ```swift
